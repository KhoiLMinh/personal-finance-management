  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/admin/categories" element={<ProtectedRoute requireAdmin={true}><AdminCategoriesPage /></ProtectedRoute>} />
        <Route path="/admin/configs" element={<ProtectedRoute requireAdmin={true}><AdminConfigsPage /></ProtectedRoute>} />
